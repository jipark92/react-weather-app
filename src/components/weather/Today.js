    ...
    return (
        <div className="today-container">
            ...
            <div className="section-1">
                <div>
                    <p>Feels Like: {!toggle? !props.weatherInfo[0].feels? "" :props.weatherInfo[0].feels - 273 + "°C": (props.weatherInfo[0].feels - 273) * (9/5) + 32 + "°F"}</p>
            ...
            <div className="section-2">
                <div>
                    <p>Temp: {!toggle? !props.weatherInfo[0].temp? "": props.weatherInfo[0].temp - 273 + "°C":(props.weatherInfo[0].temp - 273) * (9/5) + 32 + "°F"}</p>
                    <img src="https://cdn-icons-png.flaticon.com/512/3815/3815449.png"/>
                </div>
                <div>
                    <p>Temp Max: {!toggle?!props.weatherInfo[0].tempMax? "": props.weatherInfo[0].tempMax - 273 + "°C":(props.weatherInfo[0].tempMax - 273) * (9/5) + 32 + "°F"}</p>
                ...
                <div>
                    <p>Temp Min: {!toggle?!props.weatherInfo[0].tempMin? "" : props.weatherInfo[0].tempMin - 273 + "°C":(props.weatherInfo[0].tempMin - 273) * (9/5) + 32 + "°F"}</p>
